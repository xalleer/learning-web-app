...
export function QuizPage() {
  ...
  if (!module || !currentQuestion) return <Navigate to="/" replace />;
  ...
  if (finished && result) {
    ...
    return (
      <main className="mx-auto max-w-4xl space-y-5">
        <Link to={`/module/${module.slug}`} className="text-sm text-text-secondary hover:text-text-primary">← Назад до модуля</Link>
        <Card className="p-5">
